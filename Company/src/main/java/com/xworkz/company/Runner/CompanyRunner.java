...
;
        ...
        companyEntity.setCompanyCeo("Vaibahv");
        entityManager.merge(companyEntity);


        CompanyEntity companyEntity1=entityManager.find(CompanyEntity.class,5);
        CompanyEntity companyEntity2=entityManager.find(CompanyEntity.class,6);
